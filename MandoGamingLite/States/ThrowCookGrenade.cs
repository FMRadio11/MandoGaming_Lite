...
{
    class ThrowCookGrenade : GenericProjectileBaseState
    {
        public static GameObject _projectilePrefab;
        public static float _damageCoefficient = 7;
        ...
        {
            if (ConfigSetup.FragDamage.Value) _damageCoefficient = ((ConfigSetup.CustomMando.Value) ? ConfigSetup.CFragDamage.Value : 8);
            LoadStatics();
            base.OnEnter();
        }
